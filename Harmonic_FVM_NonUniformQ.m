%De functie Harmonic_FVM_NonUniformQ, deze functie is de simulatie van de differentiaal
...
%%%%%%%NOTE %%%%%%%%
%THIS non unifrom Q functionality is not available in the cpp implementatation, and only
%serves as proof of a correct implementation
