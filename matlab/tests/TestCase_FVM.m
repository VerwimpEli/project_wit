...
[Sol,K] = FVM(B, H, VB,VH,Varray,Q,65,0.2,BC0,BC1,BC2,BC3);
...
for i = 1:size(Mesh,2)
    ...
    [Sol,K] = FVM(B, H, Mesh(i),VH,Varray,Q,65,0.2,BC0,BC1,BC2,BC3);
...
for i = 1:size(Mesh,2)
    ...
    [Sol,K] = FVM_NonUniformQ(B, H, Mesh(i),VH,Varray,Q,65,0.2,BC0,BC1,BC2,BC3);
    SOL = reshape(Sol,[Mesh(i),VH]);
